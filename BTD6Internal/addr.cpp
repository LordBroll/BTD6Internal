...
void addr::init() {
	...
	// tower manager class
	add_sig(tower_manager_get_total_spent, abs_sig("\xE8\x00\x00\x00\x00\x0F\x28\xF8\x0F\x57\xC9\x0F\x2F\xF9", "x????xxxxxxxxx", 1, 4));
	...
	add_sig(xp_ctor, abs_sig("", "x????xxx????xx?????xxx????x????xxx????xxxxxxx????xxx????xxx????xx?????", 1, 4));
	...
	add_sig(xp_add_tower_xp, abs_sig("\xE8\x00\x00\x00\x00\xFF\xC3\xE9\x00\x00\x00\x00\x41\xFF\xC6", "x????xxx????xxx", 1, 4));
